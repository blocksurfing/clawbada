...
# An array, not a string: this is zsh, which does not word-split an unquoted "$VERCEL" —
# the string form looked for a command literally named "npx vercel@59.19.0" (#83 shipped that).
